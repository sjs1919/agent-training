...
>
> 说明:本文为原文整理存档,图片保留为微信图床链接,版权归原作者所有。
...
![评测三阶段](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0Dz6opSqDYibuBA0EdG2n9NAMlBTIL9ubQhibX9OOOicGU7eEOjKEQHFjbb4ZlXqJ2ibY03XbgnbptcAO5YJhxFFDKGG6M5CChZnE8s/640?wx_fmt=png&from=appmsg)
...
![Agent执行链路](https://mmecoa.qpic.cn/sz_mmecoa_png/V95GN2mm0DwmSdU3QY9EJvEeiaKb0TK9Qzib6BoevTkzicV1Q6ib9T8baS8M62mvpYlYPf4CNQmXbJhpV5lKK7Bo9eMN6ZV7BXV05DL3NrNJhWc/640?wx_fmt=png&from=appmsg)
...
![模型能力与业务结果的鸿沟](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DxiaOibeZNMa769q18GczZl9VTGHicEPzsicOTImJnzIOw24gWqvfCqYFgeQXvols5hlMszv5a7g26XKVHQOWwMnJHn6JEtSPfrXl0/640?wx_fmt=png&from=appmsg)

这两类指标不能直接映射，中间必须有一层面向任务系统的桥梁指标。我们提供一种分层思路如下：

![分层评测思路](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0Dzye1haycLoU75kx3GA84g45zm7geSfyPic6JZRicX6y2pYmd578HibuR3DcVF6gxFMFibXJHoViaWb7TzKEibBRxaPGOUWLyHraSvjE/640?wx_fmt=png&from=appmsg)
...
![客观评测与主观评测](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DxUoQG7Rvwfy5XvCWW8vMzBBe7OjLFicvWuYibpKVRKQmPIpgeicb2YWIbZWhYt4ib12bER9v3NSbbxMKdQc02XKdrFiaaJVZpVSqlk/640?wx_fmt=png&from=appmsg)
...
![人人一致](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DxEak5oAUDgUk3ajpyP5K2FvSIdbYa96wn5I44sh6VAmJuERf3iaibKUALWh1ssPgpL75nF2eI90pMzUr1kDrU5nmtFL8sVBK2Os/640?wx_fmt=png&from=appmsg)
...
![案例一：作文评测](https://mmecoa.qpic.cn/sz_mmecoa_png/V95GN2mm0Dxib32ZRGQTr46U5xJl1c9MorP4UZ2ia2O4m3NIDoIEmOEc0l3qNaUjQwUgXicGNTDcViaoVt1jniaArWGyLPpAWApvIoajSz0R6SKE/640?wx_fmt=png&from=appmsg)
...
一个成熟的评测团队，核心能力不是一开始就搭出完美系统，而是能把线上问题、失败样本、模糊反馈不断转化成结构化评测资产。我们通过Bad Case和Good Case修正评测体系的目标，逐步修正"独裁者"与真实目标之间的负面偏差。例如履约数字站长业务，项目启动之初只有20多个评测指标，而经历1年时间推全之后，我们扩展到了近200个指标。
...
![专家知识补充模型能力](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0Dyd6WKe62m3WiagLZTJzr6gOl5R4muurscJwt1EzXMbUcLJApWTia27eEYoibhkLap5CrtJkywcZc1JD85pmSic8Tuy5Pro1Z4Eals/640?wx_fmt=png&from=appmsg)
...
![长程Agent与短程Agent的区别](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DwbHVNl8DWpyzsVWlicGfTkxIsY45YogpWgbHKPe35w4FkqibyxaLq7VicV0Phl95H6PMETzAanTNr72OoO5gxTqPNb94gKyF6sX8/640?wx_fmt=png&from=appmsg)
...
![短程Agent评测重点](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0Dzs58hNXt6SibXdrNtM4JwkKwB1lFcMaNh45zwUfnHfrCm6UxG2x0pm9X8uEUjal6DNMApscDbL6EG8F0uxQyBmiaibicKaeaFjCEk/640?wx_fmt=png&from=appmsg)

在过去1年的发展中图灵形成了成熟的解决方案，包括人工评测、机器评测，部分案例如下：

![图灵短程Agent评测案例](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DyCbiavTuEaqCRQqyQx2MVlJic6vBVoB7H37I9iayrPHs1uYlBY65MvnCQoHFDtNKLByickngpibyxexsaib3f3hpICKAaweyxtd7Bia0/640?wx_fmt=png&from=appmsg)
...
![长程Agent观测与评测](https://mmecoa.qpic.cn/sz_mmecoa_png/V95GN2mm0DwHHAlpsFnLmicyQZQqeggIjpKmK8R01bcnOPyCGlnOjbWo7SWG7IecUxA28zaZySMUpYFbf8dEZE9RMdc90WBHKAIYiaRqibxNwc/640?wx_fmt=png&from=appmsg)
...
![龙虾/Skill需求三类场景](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DzVhNYpDb4urViahHjj9XeUhmImb1nr8BCFma4ttgx3vuoYUE7iczQZdehLcy2dISnibUK9E7dbE6zrkWQFdJ6U1icozjbtLmjSXpc/640?wx_fmt=png&from=appmsg)
...
![Skill全生命周期](https://mmecoa.qpic.cn/sz_mmecoa_png/V95GN2mm0Dzh1VHtt5o5yicHMWBEia0cPE4J6nm4OhCwLEswbzy1f9AV5VE5thP8tO56QECad160RVTzCcBUL0LbxQxzQjtvxYp2XOtvuTbA0/640?wx_fmt=png&from=appmsg)

综上，Skill评测的痛点总体可以拆解成三个方面：

![Skill评测三方面痛点](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DzvY82v0PbRgwH6LmdsRxRaFmXD7KkUVKkibVSymF23ZCAicKtK1XX9G7nbbomPNHkoXRic4G8bECcPbR76xho8tot5nv3av2sbsg/640?wx_fmt=png&from=appmsg)
...
![Task定义简化](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DyKnxBJic7TZiboicEJfL5rSiaymlezlcHU9JNGcz8METkXMq35ddw6zWHANRia35KqnftJ8MPdyunJACGXjDzbA42OFjQKJosyZ5BY/640?wx_fmt=png&from=appmsg)

prompt定义了我们的问题/诉求，expected behavior定义了我们预期Agent达成的行为，当我们在正式或测试环境中向Agent发送prompt，通过trace获取到长程Agent真实的执行路径，就可以得到（prompt - expected_behavior - trace）三元组，类似于短程Agent的（query - ground_truth - answer），即可进行评测。

**3.2.3 长程Agent评测与短程Agent评测的差异**

可以把两者的差异总结如下：

![长程与短程Agent评测差异](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DzOKGoYUIr9X7C4DaleTXOeNOiaShRxXnWVHVrw3DmxXLV8doIicMicHyWS6lUfmcXVXrWj5eVmMpaSs5sWhhTvkqgZUPc1al2iaas/640?wx_fmt=png&from=appmsg)
...
- **评分器（Grader）**：评估Agent性能某些方面的逻辑。一个任务可以有多个评分器，每个评分器包含多个断言（有时称为检查 Checks）。
...
- **Agent框架（Agent Harness，或 Scaffold）**：使模型能够作为Agent运行的系统：处理输入、编排工具调用并返回结果。当我们评估"一个Agent"时，我们是在评估框架和模型协同工作。例如，Claude Code是一个灵活的Agent框架，我们通过 Agent SDK使用其核心原语构建了我们的长时间运行Agent框架。
- **评估套件（Evaluation Suite）**：旨在测量特定能力或行为的任务集合。套件中的任务通常共享一个广泛的目标。例如，客户支持评估套件可能测试退款、取消和升级。

![长程Agent评测开源领域调研](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DwDhlcrU1Ry3SRrnwicZbcZWeWPH6RadePlkeqhKSic6XYvK210rQeYia4KkxNqDYciamWpG9uNLM59bmj0NmeibYib7rr3IkV4cicAV0/640?wx_fmt=png&from=appmsg)

2026年2月，龙虾在全球爆火时候，社区涌现出面向龙虾评测的开源软件：

| 软件名称 | 简介 | GitStar | task定义 |
|----------|------|---------|----------|
| pinchbench | 2026年2月开源，是一套专门用于评估OpenClaw的性能基准测试系统。与传统的合成测试（Synthetic Tests）不同，PinchBench 强调"真实场景下的任务模拟"。它通过给 AI 代理布置实际工作中会遇到的复杂任务，来衡量模型在处理多步工作、实际开发与办公环境下的真实表现。 | 1200+ | md文件 |
| claw eval | 北大发布的龙虾能力评测task列表 | 500 | yaml文件 |
| WildClawBench | WildClawBench：野生环境 AI Agent 能力评测 10 大模型谁的"龙虾"最强？核心理念是"在野生环境中测试 Agent"——不是给模型一个精心设计的沙盒，而是把它扔进真实用户每天使用 OpenClaw Agent 的场景中，看它能不能活下来。 | 500 | Skill |

![开源软件对比](https://mmecoa.qpic.cn/mmecoa_png/V95GN2mm0DxQNyZx9Jemlj2Vzhcdh8GO30t6veaa2QJX0l2tuv2YFX21YS4wib0o4YVdemC7icPGSbV1wEia8M4sJIJickcoZXqcZBRTt6fumQg/640?wx_fmt=png&from=appmsg)
